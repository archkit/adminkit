...
document.addEventListener("click", (e) => {
  ...
  if (e.target.closest("[data-js-back]")) {
    history.back();
    return;
  }
  if (e.target.closest("[data-js-reload]")) {
    location.reload();
    return;
  }
});
var isMiniMode = () => document.querySelector(".shell")?.dataset.layout === "mini";
...
var SUPPORTS_ANCHOR_POS = CSS.supports("position-area: bottom span-left");
...
var TOAST_DEFAULTS = {
  maxVisible: 5,
  durations: { note: 5e3, success: 5e3, warning: 8e3, danger: false }
};
...
window.Toast = {
  show({ title, message, variant = "note", duration, action } = {}) {
    ...
    const dur = duration !== void 0 ? duration : TOAST_DEFAULTS.durations[variant];
